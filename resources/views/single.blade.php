                    ...
                    <div class="col-lg-8">
                        <div class="sn-container">
                            <div class="sn-img">
                                ...
                                <img src="{{ Voyager::image( $blog->image ) }}" width="825px" height="525px"/>
                            </div>
...
<script>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    s.src = 'https://newslaravel.disqus.com/embed.js';
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12.14.5C5.86.5 2.7 5 2.7 8.75c0 2.27.86 4.3 2.7 5.05.3.12.57 0 .66-.33l.27-1.06c.1-.32.06-.44-.2-.73-.52-.62-.86-1.44-.86-2.6 0-3.33 2.5-6.32 6.5-6.32 3.55 0 5.5 2.17 5.5 5.07 0 3.8-1.7 7.02-4.2 7.02-1.37 0-2.4-1.14-2.07-2.54.4-1.68 1.16-3.48 1.16-4.7 0-1.07-.58-1.98-1.78-1.98-1.4 0-2.55 1.47-2.55 3.42 0 1.25.43 2.1.43 2.1l-1.7 7.2c-.5 2.13-.08 4.75-.04 5 .02.17.22.2.3.1.14-.18 1.82-2.26 2.4-4.33.16-.58.93-3.63.93-3.63.45.88 1.8 1.65 3.22 1.65 4.25 0 7.13-3.87 7.13-9.05C20.5 4.15 17.18.5 12.14.5z"/></svg>
                        ...
                        <div class="sn-related">
                            ...
                            <div class="row sn-slider">
                                ...
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        <img src="{{ Voyager::image( $all->image ) }}" width="334" height="198px" />
                                        <div class="sn-title">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar">
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="category">
                                    <ul>
                                        <li><a href="{{url('blog')}}/{{$all->id}}">Sport</a><span>(98)</span></li>
                                        <li><a href="{{url('blog')}}/{{$all->id}}">Bussiness</a><span>(87)</span></li>
                                        <li><a href="{{url('blog')}}/{{$all->id}}">Entertainment</a><span>(76)</span></li>
                                        <li><a href="{{url('blog')}}/{{$all->id}}">Technology</a><span>(43)</span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="sidebar-widget">
                                ...
                                <div class="tags">
                                    <a href="{{url('blog')}}/{{$all->id}}">Sport</a>
                                    <a href="{{url('blog')}}/{{$all->id}}">Bussiness</a>
                                    <a href="{{url('blog')}}/{{$all->id}}">Entertainment</a>
                                    <a href="{{url('blog')}}/{{$all->id}}">Technology</a>
